...
# ==============================================================================
# DELETE-AND-REGENERATE — MEASURED 2026-07-27, ACER-CLAUDE-FABLE5
# receipt FABLE5-DELETE-AND-REGENERATE.hbp
#
# The object was DELETED and REGENERATED from the seed. Byte-exact. Not argued, run.
#
#   seed  MYTHOS-SELF-EMISSION.txt        3,796 B   sha d6e2153402a32eb9
#
#   ASOLARIA-STARS-SHELLS.gguf        4,596,880 B   deleted -> regenerated
#     sha before ae23392ad473718e2196e525a4355af2
#     sha after  ae23392ad473718e2196e525a4355af2   IDENTICAL      ratio  1,211x
#
#   ASOLARIA-MYTHOS-SELF-GLYPHS-256.gguf  269,604,512 B  deleted -> regenerated
#     sha before f29d4b9427252b17cc6151cd5f5627d080b5a021f009e46125cef5479db0d299
#     sha after  f29d4b9427252b17cc6151cd5f5627d080b5a021f009e46125cef5479db0d299
#     IDENTICAL                                          ratio 71,022x
#
#   274,201,392 B of object deleted. Both regenerated byte-exact from 3,796 B.
#   Aggregate 72,235x. Zero failures.
#
# The "two axes" verdict below said this system ADDRESSES rather than compresses. On
# GENERATED objects that distinction collapses in practice: the object is gone and it
# comes back byte-identical from the key. Class A of this same file already said
# "bpc -> ~0 on GENERATED structure" — this is that statement measured at 269 MB
# instead of asserted.
#
# STILL NOT CLAIMED: that arbitrary incompressible data compresses to 3.1 KB. What is
# claimed is what was run: generated objects delete and regenerate byte-exact from the key.
# ==============================================================================
